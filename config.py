...
AccountList = [
    {
        ...
        "Authorization": "Bearer 172613713514017IzpMAAMCJBThCLrgu2JZWjU3JA5HMxRzG4RYoQHOzZjbYvreadWVoCS0maPQab7543329813",  # To get the token, refer to the README.md file
        "UserAgent": "Mozilla/5.0 (iPad; CPU OS 8_4_1 like Mac OS X) AppleWebKit/600.1.4 (KHTML, like Gecko) Version/8.0 Mobile/12H321 Safari/600.1.4",  # Refer to the README.md file to obtain a user agent
        "Proxy": { "http": "socks5://198.7.56.72:54391" },  # You can use proxies to avoid getting banned. Use {} for no proxy
        # Example of using a proxy:
        # "Proxy": {
        #   "https": "https://10.10.1.10:3128",
        #   "http": "http://jikejynd:nz6ezzusda4x@204.44.69.89:6342"
        # },
        "config": {
            ...
            "auto_upgrade_start": 10000,  # Start buying upgrades when the balance is greater than this amount
            "auto_upgrade_min": 1000,  # Stop buying upgrades when the balance is less than this amount
